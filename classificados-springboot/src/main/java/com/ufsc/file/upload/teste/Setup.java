...
public class Setup implements CommandLineRunner{
    ...
    public void run(String...args) throws Exception{
        ...
        Produto p1 = new Produto (null, "IPhone 12", 5000, 8, cat2);
        Produto p2 = new Produto (null, "Notebook Dell", 4500, 5, cat2);
        Produto p3 = new Produto (null, "Camiseta básica", 40, 30, cat1);
        Produto p4 = new Produto (null, "Bolsa de couro", 800, 10, cat1);
        Produto p5 = new Produto (null, "Onix LTZ", 80000, 3, cat3);
